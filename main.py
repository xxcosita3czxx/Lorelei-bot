...
class Help_Pages(discord.ui.View):
    ...
    async def previous_button(self, button: discord.Button, interaction: discord.Interaction):  # noqa: E501
    ...
    async def next_button(self, button: discord.Button, interaction: discord.Interaction):  # noqa: E501
